...
void WaterLevelChunk::getEntities(std::shared_ptr<Entity> except, AABB bb, vector<shared_ptr<Entity> > &es)
{
}

void WaterLevelChunk::getEntitiesOfClass(const std::type_info& ec, AABB bb, vector<shared_ptr<Entity> > &es)
{
}
