...
int BlockDestructionProgress::getId() { return id; }

int BlockDestructionProgress::getX() { return x; }

int BlockDestructionProgress::getY() { return y; }

int BlockDestructionProgress::getZ() { return z; }
...
int BlockDestructionProgress::getProgress() { return progress; }
