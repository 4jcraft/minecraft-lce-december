...
private:
    ...
    pu  // 4J: Originally strings// default rules
...
public:
    ...
    bool getBoolean(const i// 4J: Removed unused functions/*void set(const std::wstring &ruleName, const std::wstring &newValue);
