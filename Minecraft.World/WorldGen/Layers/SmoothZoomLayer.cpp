...
SmoothZoomLayer::SmoothZoomLayer(__int64 seedMixup, std::shared_ptr<Layer>parent) : Layer(seedMixup)
{
	this->parent = parent;
}
...
std::shared_ptr<Layer>SmoothZoomLayer::zoom(__int64 seed, std::shared_ptr<Layer>sup, int count)
{
