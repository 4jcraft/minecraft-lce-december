...
public:
    ...
    protected:
        ...
        void readAdditonalSaveData(CompoundTag/**
     *
     *
     */
    class MineShaftCorridor : public StructurePiece {
        ...
        protected:
            virtual bool createChest(
                Level * level, BoundingBox * chunkBB, Random * random, int x,
                int y, int z, WeighedTreasureArray treasure, int numRolls);
    ...
    class MineShaftStairs : public StructurePiece {
            ...
            public:
                MineShaftStairs();
                MineShaftStairs(int genDepth, Random* random,
            ...
            public:
                ...
                virtual void addChildren(StructurePiece * startPiece,
                                         ...
                                         Random * random);
                virtual bool postProcess(Level * level, Random * random,
                                         /* @formatter:off */ ingBox * chunkBB);
    };

    
private:
    st/* @formatter:on */eArray smallTreasureItems;
