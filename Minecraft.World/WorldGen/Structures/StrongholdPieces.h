...
public:
    class FillerCorridor : public StrongholdPiece {
        ...
        public:
            FillerCorridor();
            FillerCorridor(int genDepth, Random* random,
        ...
        public:
            static BoundingBox* findPieceBox(
...
public:
    class StairsDown : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_StairsDown;
            }
...
public:
    class Straight : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_Straight;
            }
    ...
    class ChestCorridor : public StrongholdPiece {
        ...
        public:
            virtual void addChildren(StructurePiece * startPiece,
                                     std::list<StructurePiece*> * pieces,
                                     Random * random);
            static ChestCorridor* createPiece(
                std::list<StructurePiece*> * pieces, Random * random, int footX,
                int footY, int footZ, int direction, int genDepth);
            virtual bool postProcess(Level * level, Random *
                                                        r /**
                                                           *
                                                           *
                                                           */
...
public:
    class StraightStairsDown : public StrongholdPiece {
        ...
        public:
            StraightStairsDown();
            StraightStairsDown(int genDepth, Random* random,
            ...
            static StraightStairsDown* createPiece(
                std::list<StructurePiece*> * pieces, Random * random, int footX,
                int footY, int footZ, int direction, int genDepth);
            virtual bool postProcess(Level * level, /**
                                                     *
                                                     *
                                                     */ BoundingBox * chunkBB);
    };
...
public:
    class LeftTurn : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_LeftTurn;
            }
        ...
        public:
            ...
            virtual void addChildren(StructurePiece * startPiece,
                                     std::list<StructurePiece*> * pieces,
                                     Random * random);
            static LeftTurn* createPiece(
                std::list<StructurePiece*> * pieces, Random * random, int footX,
                int footY, int footZ, int direction, int genDepth);
            virtual bool postProcess(Lev /**
                                          *
                                          *
                                          */
                                     ,
...
public:
    class RightTurn : public LeftTurn {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_RightTurn;
            }
...
public:
    class RoomCrossing : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_Strong  // 4J addedssing;
            }
...
public:
    class PrisonHall : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_PrisonHall;
            }
        ...
        public:
            ...
            virtual void addChildren(StructurePiece * startPiece,
                                     std::list<StructurePiece*> * pieces,
                                     Random * random);
            static PrisonHall* createPiece(
                std::list<StructurePiece*> * pieces, Random * random, int footX,
                int footY, int footZ, int direction, int genDepth);
        vir/**
     *
     *
     */el* level, Random* random,
                                 BoundingBox* chunkBB);
    };
...
public:
     ...
     *
     *
     */postProcess(Level* level, Random* random,
                                 BoundingBox* chunkBB);
    };
    ...
    class PortalRoom : public StrongholdPiece {
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_PortalRoom;
            }
...
private:
    class SmoothStoneSelector : public StructurePiece::BlockSelector {
        public:
            virtual void std::next(Random * random, int worldX, int worldY,
