...
public:
    ...
    static std::list<PieceWeight*>* createPieceSet(
        Random* random, int villageSiz// 4J - was ArrayList
...
private:
    ...
    static int updatePieceWeight(
        std::list<PieceWeight*>* current// 4J = was array list
    ...
    static StructurePiece* generateAndAddRoadPiece(
        StartPiece* startPiece, std::list<StructurePiece*>* pieces, Random* random,
        int footX, int footY, int footZ, in/**
     *
     *
     */
...
private:
    ...
    protected:
        ...
        static bool isOkBox(BoundingBox* box,
             // 4J added startRoom paramstartRoom);  
...
public:
    ...
    public:
        virtual EStructurePiece GetType() {
            return eStructurePiece_Villa  // these fields are only used in
        ...
        StartPiece(BiomeSource* biomeSource, int genDepth, Random* random,
                   int west, int north, std::list<PieceWeight*// 4J Added level param         int villageSize, Level* level);  
        virtual ~StartPiece();
    ...
    public:
        ...
        public:
            ...
            static BoundingBox* findPieceBox(StartPiece* startPiece,
                                             ...
                                             int footY, int footZ,
                                             int direction);
            virtual bool postProcess(Level* level, Random* r /**
                                                              *
                                                              *
                                                              */
                                     BoundingBox* chunkBB);
    ...
    public:
        ...
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_BookHouse;
            }
    ...
    public:
        ...
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_SmallHut;
            }
    ...
    public:
        ...
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_PigHouse;
            }
    ...
    public:
        ...
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_Farmland;
            }
    ...
    public:
        ...
        public:
            static DoubleFarmland* createPiece(
                StartPiece* startPiece, std::list<StructurePiece*>* pieces,
    ...
    public:
        ...
        public:
            ...
            virtual EStructurePiece GetType() {
                return eStructurePiece_LightPost;
            }
