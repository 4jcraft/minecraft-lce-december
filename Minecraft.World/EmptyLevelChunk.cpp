...
void EmptyLevelChunk::getEntities(std::shared_ptr<Entity> except, AABB bb, vector<shared_ptr<Entity> > &es, EntitySelector *selector)
{
}

void EmptyLevelChunk::getEntitiesOfClass(const std::type_info& ec, AABB bb, vector<shared_ptr<Entity> > &es, EntitySelector *selector)
{
}
