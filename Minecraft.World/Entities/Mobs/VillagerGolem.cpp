...
int VillagerGolem::decreaseAirSupply(int currentSupp// infinite air supply
...
bool VillagerGolem::hurt(DamageSource* source, float d// 4J: Protect owned golem from untrusted players
    if (isPlayerCreated()) {
