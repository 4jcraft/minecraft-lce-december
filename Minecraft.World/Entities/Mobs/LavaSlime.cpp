...
int LavaSlime::getDeathLoot() {  // 4J-PB - brought forward the magma cream
                                 // drops
...
bool LavaSlime::isInLava() {  // hack that makes the lava slimes move freely on
                              // the bottom of the lava// oceans
    return false;
}
