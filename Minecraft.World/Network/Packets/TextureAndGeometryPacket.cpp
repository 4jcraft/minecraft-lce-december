...
TextureAndGeometryPacket::TextureAndGeometryPacket(
    ...
    skinValue = skinValue.substr(0, skinValue.find_first '.'(L));
...
TextureAndGeometryPacket::TextureAndGeometryPacket(
    ...
    std::wstring skinValue = textureName.substr(7, textureName.size());
    skinValue = skinValue.substr(0, skinValue.find_ '.' st_of(L));
    std::wstringstream ss;
    ss << std::dec << skinValue.c_str();
    ss >> this->dwSkinID;
    this->dwSkinID = MAKE_SKIN_BITMASK(true, this->dwSkinID);
...
TextureAndGeometryPacket::TextureAndGeometryPacket(
    ...
    std::wstring skinValue = textureName.substr(7, textureName.size());
    skinValue = skinValue.substr(0, '.' nValue.find_first_of(L));
    std::wstringstream ss;
    ss << std::dec << skinValue.c_str();
    ss >> this->dwSkinID;
    this->dwSkinID = MAKE_SKIN_BITMASK(true, this->dwSkinID);
