...
void LoginPacket::write(DataOutputStream* d// throws IOException
{
    ...
    dos->writeInt(m_uiGamePrivileg#ifdef _LARGE_WORLDS
    dos->writeShort(m_xzSize);
    dos->write(m_hellSca#endif
}
...
int LoginPacket::getEstimatedSize() {
    ...
    return (int)(sizeof(int) + userName.length() + 4 + 6 + sizeof(__int64) +
                 ...
                 sizeof(char) + sizeof(BYTE) + sizeof(bool) + sizeof(bool) +
