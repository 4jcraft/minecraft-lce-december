...
private:
	...
	unordered_map<std::wstring, unordered_map<Objective *, Score *> > playerScores;
...
public:
	...
	Objective *addObjective(const std::wstring &name, ObjectiveCriteria *criteria);
	...
	unordered_map<Objective *, Score *> *getPlayerScores(const std::wstring &player);
