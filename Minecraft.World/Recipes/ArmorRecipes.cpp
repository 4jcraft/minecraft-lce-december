...
void ArmorRecipes::_init() {
    ...
    ADD_OBJECT(map[0],
               Item::leather);  //	ADD_OBJECT(map[0],Tile::fire);
    ...
    ADD_OBJECT(
        map[1],
        Item::helmet_leather);  //	ADD_OBJECT(map[1],Item::helmet_chain);
    ...
    ADD_OBJECT(
        map[2],
        Item::chestplate_leather);  //	ADD_OBJECT(map[2],Item::chestplate_chain);
    ...
    ADD_OBJECT(
        map[3],
        Item::leggings_leather);  //	ADD_OBJECT(map[3],Item::leggings_chain);
    ...
    ADD_OBJECT(
        map[4],
        Item::boots_gold)  // 4J-PB added for quick equip in the inventory
