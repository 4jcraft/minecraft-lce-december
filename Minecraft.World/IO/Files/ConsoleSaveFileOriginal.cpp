...
void ConsoleSaveFileOriginal::PrepareForWrite(FileEntry* file,
...
BOOL ConsoleSaveFileOriginal::writeFile(FileEntry* file, LPCVOID lpBuffer,
                                        DWORD nNumberOfBytesToWrite,
...
BOOL ConsoleSaveFileOriginal::readFile(FileEntry* file, LPVOID lpBuffer,
...
void ConsoleSaveFileOriginal::MoveDataBeyond(FileEntry* file,
                                             DWORD nNumberOfBytesToWrite) {
    DWORD numberOfBytesRead = 0;
    DWORD numberOfBytesWritten = 0;
...
void ConsoleSaveFileOriginal::DebugFlushToFile(
    ...
    if (compressedData != NULL && compressedDataSize > 0) {
        ...
        VirtualWriteFile(lpFileName, compressedData, compressedDataSize,
