...
#ifdef _DURANGO
    m_fileHandle = CreateFile(file.getPath().c_str(),  // file name
                              GENERIC_WRITE,           // access mode
                              0,  // share mode // TODO 4J Stu - Will we need to
                                  // share file? Probably not but...
                              NULL,                   // Unused
...
#else
    m_fileHandle = CreateFile(wstringtofilename(file.getPath()),  // file name
                              GENERIC_WRITE,                      // access mode
                              0,  // share mode // TODO 4J Stu - Will we need to
                                  // share file? Probably not but...
                              NULL,                   // Unused
