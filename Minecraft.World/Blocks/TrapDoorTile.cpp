...
bool TrapDoorTile::blocksLight() { return false; }

bool TrapDoorTile::isSolidRender(bool isServerLevel) { return false; }

bool TrapDoorTile::isCubeShaped() { return false; }
...
HitResult* TrapDoorTile::clip(Level* level, int xt, int yt, int zt, Vec3* a,
                              Vec3* b) {
...
bool TrapDoorTile::isOpen(int data) { return (data & 4) != 0; }
