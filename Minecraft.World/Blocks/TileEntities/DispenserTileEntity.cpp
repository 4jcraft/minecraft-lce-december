...
bool DispenserTileEntity::removeProjectile(int itemId) {
        ...
        void DispenserTileEntity::load(CompoundTag * base) {
            ...
            ListTag<CompoundTag>* inventoryList =
                (ListTag < CompoundT "Items" se->getList(L);
                 delete[] items.data;
        ...
        void DispenserTileEntity::save(CompoundTag * base) {
            ...
            for (unsigned int i = 0; i < items.length; i++) {
                ...
                "Items" base->put(L, listTag);
    if (hasCustomName("CustomName"String(L, name);
            }
            ...
            bool DispenserTileEntity::stillValid(
                ...
                if (level->getTileEntity(x, y, z) != shared_from_this())
                    return false;
                if (player->distanceToSqr(x + 0.5, y + 0.5, z + 0.5) > 8 * 8)
                    return false;
                return true;
            }
            ...
            bool DispenserTileEntity::canPlaceItem(
