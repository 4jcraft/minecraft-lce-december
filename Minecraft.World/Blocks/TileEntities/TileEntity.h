...
private:
    ...
    static void setId(tileEntityCreateFn createFn, eINSTANCEOF clas,
                      std::wstring id);
    bool remove;
unsigned char renderRemo  // 4J added
    ...
    pu  // 4J Java does not have a ctor, but we need one to do some
        // initialisation// of the member variables
    TileEntity();
    virtual ~TileEntity() {}

    void setRenderRemoveStage(unsigned char// 4J added
    ...
    virtual void clearCach// 4J Added
