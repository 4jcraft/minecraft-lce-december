...
public:
	...
	void setPlacedBy(Level *level, int x, int y, int z, std::shared_ptr<LivingEntity> by);
	...
	void checkMobSpawn(Level *level, int x, int y, int z, std::shared_ptr<SkullTileEntity> placedSkull);
