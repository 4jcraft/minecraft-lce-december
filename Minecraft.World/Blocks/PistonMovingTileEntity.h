...
public:
	...
	static std::shared_ptr<TileEntity> newMovingPieceEntity(int block, int data, int facing, bool extending, bool isSourcePiston);
...
private:
	std::shared_ptr<PistonPieceEntity> getEntity(LevelSource *level, int x, int y, int z);
