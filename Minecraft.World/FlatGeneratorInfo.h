...
private:
	...
	unordered_map<std::wstring, unordered_map<std::wstring, std::wstring> > structures;
	int biome;
...
public:
	...
	unordered_map<std::wstring, unordered_map<std::wstring, std::wstring> > *getStructures();
	vector<FlatLayerInfo *> *getLayers();
	void updateLayers();
	std::wstring toString();

private:
	static FlatLayerInfo *getLayerFromString(const std::wstring &input, int yOffset);
	static vector<FlatLayerInfo *> *getLayersFromString(const std::wstring &input);
