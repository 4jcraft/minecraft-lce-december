...
public:
	...
	virtual void handleEntityLinkPacket(std::shared_ptr<SetEntityLinkPacket> packet);
	...
	virtual void handleSetDisplayObjective(std::shared_ptr<SetDisplayObjectivePacket> packet);
	virtual void handleSetPlayerTeamPacket(std::shared_ptr<SetPlayerTeamPacket> packet);
	virtual void handleParticleEvent(std::shared_ptr<LevelParticlesPacket> packet);
	virtual void handleUpdateAttributes(std::shared_ptr<UpdateAttributesPacket> packet);
	virtual void handleTileEditorOpen(std::shared_ptr<TileEditorOpenPacket> tileEditorOpenPacket);
