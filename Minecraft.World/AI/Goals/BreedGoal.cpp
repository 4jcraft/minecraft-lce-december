...
void BreedGoal::breed() {
    ...
    partner.lock()->setDespawnProtected(// This will be NULL if we've hit our limits for spawning any particular// type of animal... reset things as normally as we can, without// actually producing any offspring     
        animal->resetLove();
    ...
    double za = random->nextGaussian() * 0.02;
        level->addParticle(
            ...
            animal->z + random->nextFloat() * animal->bbWidth * 2 -
                animal-// 4J-PB - Fix for 106869- Customer Encountered: TU12: Content: Gameplay:// Breeding animals does not give any Experience Orbs.
