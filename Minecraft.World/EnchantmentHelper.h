...
private:
	...
	*/
public:
	static float getDamageBonus(std::shared_ptr<LivingEntity> source, std::shared_ptr<LivingEntity> target);
	static int getKnockbackBonus(std::shared_ptr<LivingEntity> source, std::shared_ptr<LivingEntity> target);
	...
	static std::shared_ptr<ItemInstance> getRandomItemWith(Enchantment *enchantment, std::shared_ptr<LivingEntity> source);
