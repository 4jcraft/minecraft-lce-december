...
private:
	...
	void _init(eMODIFIER_ID id, const std::wstring name, double amount, int operation);
...
public:
	...
	HtmlString getHoverText(eATTRIBUTE_ID attribute); // 4J: Added to keep modifier readable std::string creation in one place
};