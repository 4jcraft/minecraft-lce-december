...
public:
    ...
    AnvilMenu(shared_ptr<Inventory> inventory, Level* level, int xt, int yt,
              int zt, shared_ptr<Player> player);
    ...
    shared_ptr<ItemInstance> quickMoveStack(shared_ptr<Player> player,
                                            int slotIndex);
