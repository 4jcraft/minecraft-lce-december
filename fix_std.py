...
_RAW_SYMBOLS: list[tuple[str, list[str]]] = [
    ...
    ("std::{}", [
        ...
        "replace_if", "reverse_copy", "rotate", "rotate_copy",
    ...
    ("std::{}", [
        ...
        "fpos", "char_traits", "basic_streambuf", "streambuf",
    ...
    # <optional> (C++17, but commonly used with C++11 compilers via backports)
    ("std::{}", ["optional", "nullopt", "nullopt_t", "bad_optional_access", "make_optional"]),
    # <queue>
    ...
    # <tuple>
    ("std::{}", [
        "tuple", "make_tuple", "tie", "forward_as_tuple", "tuple_cat",
