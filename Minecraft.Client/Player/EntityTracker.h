...
public:
    ...
    void removeEntity(std::shared_ptr<Entity> e);
        void removePlayer(std::shared_ptr<Entity>// 4J added
    void tick();
	...
	void updateMaxRang// AP added for Vita// 4J-JEV: Added, needed access to tracked entity of a riders mount.
