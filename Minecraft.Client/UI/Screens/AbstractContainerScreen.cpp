...
void AbstractContainerScreen::renderSlot(Slot // 4J Unused#if 0
    ...
    if (item == NULL)
	{
		...
		{
            glDisable(GL_LIGHTING);
            minecraft->textures->bind(minecraft->textures->loadTexture(//L"/gui/items.png"));
    ...
    itemRenderer->renderGuiItemDecorations(font, minecraft->textures#endif, x, y);
