...
// fill(0, 0, width, height, 0x40000000);
    ...
    drawCenteredString(font, language->getElem"selectWorld.renameTitle"), width / 2, height / 4 - 60 + 20, 0xffffff);
    drawString(font, language->getElem"selectWorld.enterName"), width / 2 - 100, 47, 0xa0a0a0);
