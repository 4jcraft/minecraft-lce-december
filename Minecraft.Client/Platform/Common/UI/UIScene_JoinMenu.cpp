    ...
    switch ((int)controlId) {
        case eControl_JoinGame: {
            ...
            ProfileManager.CheckMultiplayerPrivileges(
                m_iPad, true, &checkPrivilegeCallback,
...
#ifdef _DURANGO
void UIScene_JoinMenu::checkPrivilegeCallback(LPVOID lpParam, bool hasPrivilege,
                                              int iPad) {
    UIScene_JoinMenu* pClass =
        (UIScene_JoinMenu*)ui.GetSceneFromCallbackId((size_t)lpParam);
