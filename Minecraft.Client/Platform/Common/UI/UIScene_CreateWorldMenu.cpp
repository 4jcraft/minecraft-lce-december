...
#ifdef _DURANGO
void UIScene_CreateWorldMenu::checkPrivilegeCallback(LPVOID lpParam,
                                                     bool hasPrivilege,
                                                     int iPad) {
...
int UIScene_CreateWorldMenu::KeyboardCompleteWorldNameCallback(LPVOID lpParam,
                                                               bool bRes) {
    UIScene_CreateWorldMenu* pClass = (UIScene_CreateWorldMenu*)lpParam;
    pClass->m_bIgnoreInput = false;
...
void UIScene_CreateWorldMenu::CreateGame(UIScene_CreateWorldMenu* pClass,
    ...
    if (wSeed.length() != 0) {
		...
		else
		{
                ...
                param->findSee  // 4J - java code sets the seed to was (new
            ...
            app.SetGameHostOption(
                ...
                app.GetGameSettings(pClass->m_iPad,
            ...
            app.SetGameHostOption(
                ...
                app.GetGameSettings(pClass->m_iPad, eGameSetting_BedrockFog)
                    ? 1
                    : 0);

            app.SetGameHostOption(eGameHostOption_GameType,
                                  pClass->m_iGameModeId);
	...
	ui.NavigateToScene(pClass->m_iPad,eUIScene_FullscreenProgress, loadingParams);
        ...
        int UIScene_CreateWorldMenu::StartGame_SignInReturned(
			...
			if(isOnlineGame && (noPrivileges || noUGC) )
			{
                    if (noUGC) {
                        ...
                        ui.RequestAlertMessage(
                            ...
                            IDS_NO_USER_CREATED_CONTENT_PRIVILEGE_CREATE, uiIDA,
...
int UIScene_CreateWorldMenu::ConfirmCreateReturned(
    ...
    if (isClientSide && noUGC) {
        ...
        UINT uiIDA[1];
        uiIDA[0] = IDS_CONFIRM_OK;
        ui.RequestAlertMessage(IDS_FAILED_TO_CREATE_GAME_TITLE,
