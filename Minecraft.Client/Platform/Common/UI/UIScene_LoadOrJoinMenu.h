...
public:
    static int LoadSaveDataThumbnailReturned(LPVOID lpParam, PBYTE pbThumbnail,
...
private:
    ...
    static void remoteStorageGetSaveCallback(LPVOID lpParam,
    ...
    static int SaveTransferUpdateProgress(LPVOID lpParam,
    ...
    static int CrossSaveGetSavesInfoCallback(LPVOID lpParam,
    ...
    static void SaveTransferReturned(LPVOID lpParam,
                                     SonyRemoteStorage::Status s,
                                     int error_code);
...
private:
    ...
    static void SaveUploadReturned(LPVOID lpParam, SonyRemoteStorage::Status s,
                                   int error_code);
    ...
    static int CopySaveDataReturned(LPVOID lpParameter, bool success,
