...
void IUIScene_CreativeMenu::staticCtor() {
        std::vector< std::shared_ptr<ItemInstance> > *std::list// Building Blocks
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::SAND_SLA// AP - changed oak slab to be wood because it wouldn't burn//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
		...
		ITEM_AUX(Tile::clayHardened_colored_Id// Red
		ITEM_AUX(Tile::clayHardened_colored_I// Orange
		ITEM_AUX(Tile::clayHardened_colored_I// Yellow
		ITEM_AUX(Tile::clayHardened_colored_I// Lime
		ITEM_AUX(Tile::clayHardened_colored_I// Light Blue
		ITEM_AUX(Tile::clayHardened_colored_I// Cyan
		ITEM_AUX(Tile::clayHardened_colored_Id// Blue
		ITEM_AUX(Tile::clayHardened_colored_Id// Purple
		ITEM_AUX(Tile::clayHardened_colored_I// Magenta
		ITEM_AUX(Tile::clayHardened_colored_I// Pink
		ITEM_AUX(Tile::clayHardened_colored_I// White
		ITEM_AUX(Tile::clayHardened_colored_I// Light Gray
		ITEM_AUX(Tile::clayHardened_colored_I// Gray
		ITEM_AUX(Tile::clayHardened_colored_Id// Black
		ITEM_AUX(Tile::clayHardened_colored_Id// Green
		ITEM_AUX(Tile::clayHardened_colored_Id// Brown// Decoration
	DEF(eCreativeInventory_Decoration)
		...
		ITEM(Tile::cactus_Id)
		ITEM(Tile::topSnow_I// 4J-PB - Already got sugar cane in Materials ITEM_11(Tile::reeds_Id)
		ITEM(Tile::web_Id)
		...
		ITEM_AUX(Tile::wool_Id// Red
		ITEM_AUX(Tile::wool_I// Orange
		ITEM_AUX(Tile::wool_I// Yellow
		ITEM_AUX(Tile::wool_I// Lime
		ITEM_AUX(Tile::wool_I// Light Blue
		ITEM_AUX(Tile::wool_I// Cyan
		ITEM_AUX(Tile::wool_Id// Blue
		ITEM_AUX(Tile::wool_Id// Purple
		ITEM_AUX(Tile::wool_I// Magenta
		ITEM_AUX(Tile::wool_I// Pink
		ITEM_AUX(Tile::wool_I// White
		ITEM_AUX(Tile::wool_I// Light Gray
		ITEM_AUX(Tile::wool_I// Gray
		ITEM_AUX(Tile::wool_Id// Black
		ITEM_AUX(Tile::wool_Id// Green
		ITEM_AUX(Tile::wool_Id// Brown

		ITEM_AUX(Tile::woolCarpet_Id// Red
		ITEM_AUX(Tile::woolCarpet_I// Orange
		ITEM_AUX(Tile::woolCarpet_I// Yellow
		ITEM_AUX(Tile::woolCarpet_I// Lime
		ITEM_AUX(Tile::woolCarpet_I// Light Blue
		ITEM_AUX(Tile::woolCarpet_I// Cyan
		ITEM_AUX(Tile::woolCarpet_Id// Blue
		ITEM_AUX(Tile::woolCarpet_Id// Purple
		ITEM_AUX(Tile::woolCarpet_I// Magenta
		ITEM_AUX(Tile::woolCarpet_I// Pink
		ITEM_AUX(Tile::woolCarpet_I// White
		ITEM_AUX(Tile::woolCarpet_I// Light Gray
		ITEM_AUX(Tile::woolCarpet_I// Gray
		ITEM_AUX(Tile::woolCarpet_Id// Black
		ITEM_AUX(Tile::woolCarpet_Id// Green
		ITEM_AUX(Tile::woolCarpet_Id// Brown
#if 0
		ITEM_AUX(Tile::stained_glass_Id  // Red
		ITEM_AUX(Tile::stained_glass_I// Orange
		ITEM_AUX(Tile::stained_glass_I// Yellow
		ITEM_AUX(Tile::stained_glass_I// Lime
		ITEM_AUX(Tile::stained_glass_I// Light Blue
		ITEM_AUX(Tile::stained_glass_I// Cyan
		ITEM_AUX(Tile::stained_glass_Id// Blue
		ITEM_AUX(Tile::stained_glass_Id// Purple
		ITEM_AUX(Tile::stained_glass_I// Magenta
		ITEM_AUX(Tile::stained_glass_I// Pink
		ITEM_AUX(Tile::stained_glass_I// White
		ITEM_AUX(Tile::stained_glass_I// Light Gray
		ITEM_AUX(Tile::stained_glass_I// Gray
		ITEM_AUX(Tile::stained_glass_Id// Black
		ITEM_AUX(Tile::stained_glass_Id// Green
		ITEM_AUX(Tile::stained_glass_Id// Brown

		ITEM_AUX(Tile::stained_glass_pane_Id// Red
		ITEM_AUX(Tile::stained_glass_pane_I// Orange
		ITEM_AUX(Tile::stained_glass_pane_I// Yellow
		ITEM_AUX(Tile::stained_glass_pane_I// Lime
		ITEM_AUX(Tile::stained_glass_pane_I// Light Blue
		ITEM_AUX(Tile::stained_glass_pane_I// Cyan
		ITEM_AUX(Tile::stained_glass_pane_Id// Blue
		ITEM_AUX(Tile::stained_glass_pane_Id// Purple
		ITEM_AUX(Tile::stained_glass_pane_I// Magenta
		ITEM_AUX(Tile::stained_glass_pane_I// Pink
		ITEM_AUX(Tile::stained_glass_pane_I// White
		ITEM_AUX(Tile::stained_glass_pane_I// Light Gray
		ITEM_AUX(Tile::stained_glass_pane_I// Gray
		ITEM_AUX(Tile::stained_glass_pane_Id// Black
		ITEM_AUX(Tile::stained_glass_pane_Id// Green
		ITEM_AUX(Tile::stained_glass_pane_Id// Brown#endif
	...
	DEF(eCreativeInventory_ArtToolsDecorations)
		if(app.DebugSettingsOn())
		{
			...
			BuildFirework(std::list, FireworksItem::TYPE_BIG, DyePowderItem::PURPLE, 1, false, false);

			BuildFirework(std::list, FireworksItem::TYPE_SMALL, DyePowderItem::RED, 1, false, false);
			BuildFirework(std::list, FireworksItem::TYPE_SMALL, DyePowderItem::RED, 2, false, false);
			BuildFirework(std::list, FireworksItem::TYPE_SMALL, DyePowderItem::RED, 3, false, false);

			BuildFirework(std::list, FireworksItem::TYPE_BURST, DyePowderItem::GREEN, 1, false, true);
			BuildFirework(std::list, FireworksItem::TYPE_CREEPER, DyePowderItem::BLUE, 1, true, false);
			BuildFirework(std::list, FireworksItem::TYPE_STAR, DyePowderItem::YELLOW, 1, false, false);
			BuildFirework(std::list, FireworksItem::TYPE_BIG, DyePowderItem::WHITE, 1, true, tr// Red			ITEM_AUX(Tile::stained_glass_Id,14)	// Orange	ITEM_AUX(Tile::stained_glass_Id,1)	// Yellow	ITEM_AUX(Tile::stained_glass_Id,4)	// Lime			ITEM_AUX(Tile::stained_glass_Id,5)	// Light BlueM_AUX(Tile::stained_glass_Id,3)	// Cyan			ITEM_AUX(Tile::stained_glass_Id,9)	// Blue		ITEM_AUX(Tile::stained_glass_Id,11)	// PurpleITEM_AUX(Tile::stained_glass_Id,10)	// MagentaITEM_AUX(Tile::stained_glass_Id,2)	// Pink			ITEM_AUX(Tile::stained_glass_Id,6)	// White		ITEM_AUX(Tile::stained_glass_Id,0)	// Light GrayM_AUX(Tile::stained_glass_Id,8)	// Gray			ITEM_AUX(Tile::stained_glass_Id,7)	// Black	ITEM_AUX(Tile::stained_glass_Id,15)	// Green	ITEM_AUX(Tile::stained_glass_Id,13)	// Brown	ITEM_AUX(Tile::stained_glass_Id,12)	
// RedEM_AUX(Tile::stained_glass_pane_Id,14)	// Orange_AUX(Tile::stained_glass_pane_Id,1)	// Yellow_AUX(Tile::stained_glass_pane_Id,4)	// LimeEM_AUX(Tile::stained_glass_pane_Id,5)	// Light Blue(Tile::stained_glass_pane_Id,3)	// CyanEM_AUX(Tile::stained_glass_pane_Id,9)	// BlueM_AUX(Tile::stained_glass_pane_Id,11)	// PurpleAUX(Tile::stained_glass_pane_Id,10)	// MagentaAUX(Tile::stained_glass_pane_Id,2)	// PinkEM_AUX(Tile::stained_glass_pane_Id,6)	// WhiteM_AUX(Tile::stained_glass_pane_Id,0)	// Light Gray(Tile::stained_glass_pane_Id,8)	// GrayEM_AUX(Tile::stained_glass_pane_Id,7)	// Black_AUX(Tile::stained_glass_pane_Id,15)	// Green_AUX(Tile::stained_glass_pane_Id,13)	// Brown_AUX(#endifsta// Redstonepane_Id,12)	
		}
	...
	DEF(eCreativeInventory_Redstone)
		...
		ITEM(Tile::weightedPlate_heav// Transport(Tile::weightedPlate_light_Id)
	...
	DEF(eCreativeInventory_Misc)
		...
		ITEM(Item::nethe// Creeper		ITEM_AUX(Item::spawnEgg_Id, 50); // Skeleton	ITEM_AUX(Item::spawnEgg_Id, 51); // Spider
		ITEM_AUX(Item::spawnEgg_Id, 52); // Zombie
		ITEM_AUX(Item::spawnEgg_Id, 54); // Slime
		ITEM_AUX(Item::spawnEgg_Id, 55);// Ghast
		ITEM_AUX(Item::spawnEgg_Id, 56);// Zombie Pigman_AUX(Item::spawnEgg_Id, 57); // Enderman	ITEM_AUX(Item::spawnEgg_Id, 58); // Cave SpiderEM_AUX(Item::spawnEgg_Id, 59); // SilverfishTEM_AUX(Item::spawnEgg_Id, 60); // Blaze
		ITEM_AUX(Item::spawnEgg_Id, 61);// Magma CubeTEM_AUX(Item::spawnEgg_Id, 62); // Bat
		ITEM_AUX(Item::spawnEgg_Id, 65// Witch
		ITEM_AUX(Item::spawnEgg_Id, 66);// Pig
		ITEM_AUX(Item::spawnEgg_Id, 90// Sheep
		ITEM_AUX(Item::spawnEgg_Id, 91);// Cow
		ITEM_AUX(Item::spawnEgg_Id, 92// Chicken		ITEM_AUX(Item::spawnEgg_Id, 93); // Squid
		ITEM_AUX(Item::spawnEgg_Id, 94);// Wolf
		ITEM_AUX(Item::spawnEgg_Id, 95)// MooshroomITEM_AUX(Item::spawnEgg_Id, 96); // Ozelot
		ITEM_AUX(Item::spawnEgg_Id, 98); // Horse
		ITEM_AUX(Item::spawnEgg_Id, 100); 
		ITEM_AUX(Item::spawnEgg_Id, 100// DonkeytyHorse::TYPE_DONKEY + 1) << 12) ); 
		ITEM_AUX(Item::spawnEgg_Id, // Mule(EntityHorse::TYPE_MULE + 1) << 12));// VillagerITEM_AUX(Item::spawnEgg_Id, 120); 
		...
		BuildFirework(std::list, FireworksItem::TYPE_SMALL, DyePowderItem::LIGHT_BLUE, 1, true, false);
		BuildFirework(std::list, FireworksItem::TYPE_CREEPER, DyePowderItem::GREEN, 2, false, false);
		BuildFirework(std::list, FireworksItem::TYPE_MAX, DyePowderItem::RED, 2, false, false, DyePowderItem::ORANGE);
		BuildFirework(std::list, FireworksItem::TYPE_BURST, DyePowderItem::MAGENTA, 3, true, false, DyePowderItem::BLUE);
		BuildFirework(std::list, FireworksItem::TYPE
#ifndef _CONTENT_PACKAGELOW, 2, false, true, DyePowderItem::ORANGE);

	DEF(eCreativeInventory_ArtToolsMisc)
		if(app.DebugSettingsOn())
		{
			ITEM_AU// SkeletonwnEgg_Id, 100 | ((EntityHorse::TYPE_SKELETON + 1) << 12)); 
			ITEM_// Zombie:spawnEgg_Id, 100 | ((EntityHorse::TYPE_UNDEAD + 1) << 12)); 
			ITEM_AUX(Item::spawnEgg_Id,  98 | ((Ocelot::TYPE_BLACK + 1) << 12));
			ITEM_AUX(Item::spawnEgg_Id,  98 | ((Ocelot::TYPE_RED + 1) << 12));
			ITEM_AUX(Item::spawnEgg_Id,  98 | ((Ocelot::TYPE_S// Spider-Jockey2));
			ITEM_AUX(Item::spawnEgg_Id,  5// Enderdragon; #endif// Food	ITEM_AUX(Item::spawnEgg_Id,  63); 
		}


	
	DEF(eCreativeInventory_Food)
		ITEM(Item::ap// EnchantedEM(Item::apple_gold_Id)
		...
		ITEM(Item::ca// Tools, Armour and Weapons (Complete)
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		for(unsigned int i = 0; i < Enchantment::enchantments.length; ++i)
		{
			...
			list->push_back(Item::enchantedBook->createForEnchantment(ne
#ifndef _CONTENT_PACKAGEhantment, enchantment->getMaxLevel())));
		}

		if(app.DebugSettingsOn())
		{
			std::shared_ptr<ItemInstance> debugSword = std::shared_ptr<ItemInstance>(new ItemInstance(Item::sword_diamond_Id, 1, 0));
			debugSword->"Sword of Debug"ment::damageBonus, 50 );
			debugSword-#endifver// Materials);
	...
	DEF(eCreativeInventory_Materials)
		...
		ITEM(Item::goldNugget_Id)// RedM(Item::netherwart_seeds_Id)
		ITEM_// Orange:dye_powder_Id,1)		
		ITEM_AUX// Yellowe_powder_Id,14)	
		ITEM_AUX// Limedye_powder_Id,11)	
		ITEM_A// Light Bluepowder_Id,10)	
		ITEM_AUX(Ite// Cyanpowder_Id,12)	
		ITEM_A// Blue::dye_powder_Id,6)		
		ITEM_A// Purpledye_powder_Id,4)		
		ITEM_AUX// Magenta_powder_Id,5)		
		ITEM_AUX(// Pinkye_powder_Id,13)	
		ITEM_A// Bone Meal_powder_Id,9)		
		ITEM_AUX(It// Light grayr_Id,15)	
		ITEM_AUX(Ite// Graypowder_Id,7)		
		ITEM_A// black (ink sac)r_Id,8)		
		ITEM_AUX(Item::dy// Green_Id,0)		
		ITEM_AU// Browndye_// Brewing (TODO)
		...
		ITEM(Item::speckle// Water bottle		(It//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_TYPE_AWKWARD)) // Awkward Potion


		DEF(eCreativeInventory_Potions_Basic)
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_REGENERATION))
			I//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_FIRE_RESISTANCE))
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_POISON))
			ITEM_AUX(//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_WEAKNESS))
			ITEM//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_SLOWNESS))
			...
			ITEM_AUX(It//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_FIRE_RESISTANCE))
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_POISON))
			ITEM_AUX(Item::poti//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_WEAKNESS))
			ITEM_AUX(Item://ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_SLOWNESS))
		...
		DEF(eCreativeInventory_Potions_Level2)
			...
			ITEM_AUX(Ite//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INSTANTHEALTH))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_NIGHTVISION))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INVISIBILITY))
			...
			ITEM//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INSTANTDAMAGE))
			...
			ITEM_AUX(Item::potion_//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTHEALTH))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_NIGHTVISION))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INVISIBILITY))
			...
			ITEM_AUX(Item://ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTDAMAGE))

		DEF(eCreativeInventory_Potions_Extended)
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_REGENERATION))
			ITEM_AUX(Item//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_FIRE_RESISTANCE))
			ITEM_AUX(Item://ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INSTANTHEALTH))
			ITEM// 4J- Moved here as there isn't a weak variant of this potion.SION))	
			ITEM_// 4J- Moved here as there isn't a weak variant of this potion.LITY//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_WEAKNESS))
			ITEM_AUX(Item::p//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_SLOWNESS))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INSTANTDAMAGE))
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_REGENERATION))
			ITEM_AUX(Item::potion_I//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_FIRE_RESISTANCE))
			ITEM_AUX(Item::potion_Id//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTHEALTH))
			ITEM_AUX(Item::// 4J- Moved here as there isn't a weak variant of this potion.ION))		
			ITEM_AUX(Item::// 4J- Moved here as there isn't a weak variant of this potion.LITY//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_WEAKNESS))
			ITEM_AUX(Item::potion_Id,M//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_SLOWNESS))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTDAMAGE))
		...
		DEF(eCreativeInventory_Potions_Level2_Extended)
			...
			ITEM_AUX(Item::poti//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2EXTENDED, MASK_NIGHTVISION))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2EXTENDED, MASK_INVISIBILITY))
			ITEM_AUX(Item::p// 4J- Moved here as there isn't a weak variant of this potion.SION))	
			ITEM_AUX(Item::po// 4J- Moved here as there isn't a weak variant of this potion.LITY))	
			...
			ITEM_AUX(Item::potion_Id,MACR//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2EXTENDED, MASK_NIGHTVISION))//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2EXTENDED, MASK_INVISIBILITY))
			ITEM_AUX(Item::potion_Id,MA// 4J- Moved here as there isn't a weak variant of this potion.ION))		
			ITEM_AUX(Item::potion_Id,MA// 4J- Moved here as there isn't a weak variant of this potion.LITY))	
			...
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INS// Top Row))


		specs = new TabSpec*[eCreativeInventoryTab_COUNT];

	
	ECreative_Inventory_Groups blocksGroup[] = {eCreativeInventory_Buildin"Structures"pecs[eCreativeInventoryTab_BuildingBlocks] = new T
#ifndef _CONTENT_PACKAGEGROUPNAME_BUILDING_BLOCKS, 1, blocksGroup);

	ECreative_Inventory_Groups decorationsGroup[] = {eCreativeInventory_Decoration};
	ECreative_Inventory_Groups debugDecorationsGroup[] = {eCreativeInventory_ArtToolsD"Decoration"
	specs[eCreativeInventoryTab_Decorations] = new TabSpec(L, IDS_GROUPNAME_#elseATIONS, 1, decorationsGroup, 0, NULL, 1, debugDecorationsGroup);

	ECreative_Inventory_Groups decorationsGroup[] = {eCreativeInventory_"Decoration"
	specs[eCreativeInventoryTab_Decorations] = new Ta#endifL, IDS_GROUPNAME_DECORATIONS, 1, decorationsGroup);


	ECreative_Inventory_Groups redAndTranGroup[] = {eCreativeInventory_Transport, eCreativeInventory_Redston"RedstoneAndTransport"ventoryTab_RedstoneAndTransport] = new TabSpec(L, IDS_GROUPNAME_REDSTONE_AND_TRANSPORT, 2, redAndTranGroup);

	ECreative_Inventory_Groups materialsGroup[] = {eCreativeInvento"Materials"s};
	specs[eCreativeInventoryTab_Materials] = new TabSpec(L, IDS_GROUPNAME_MATERIALS, 1, materialsGroup);

	ECreative_Inventory_Groups foodGroup[] = {eCreat"Food"entory_Food};
	specs[eCreativeInventoryTab_Food] = new TabSpec(L, IDS_GROUPNAME_FOOD, 1, foodGroup);

	ECreative_Inventory_Groups toolsGroup[] = {eCreativeInventory_ToolsArmourWea"Tools"	specs[eCreativeInventoryTab_ToolsWeaponsArmor] = new TabSpec(L, IDS_GROUPNAME_TOOLS_WEAPONS_ARMOR, 1, toolsGroup);

	ECreative_Inventory_Groups brewingGroup[] = {eCreativeInventory_Brewing, eCreativeInventory_Potions_Level2_Extended, eCreativeInventory_Potions_Extended, eC// Just use the text LT - the graphic doesn't fit in splitscreen either// In 480p there's not enough room for the LT button, so use text instead//if(!RenderManager.IsHiDef() && !RenderManager.IsWidescreen())
	"Brewing"
	{
		specs[eCreativeInventoryTab_Brewing] = new// 	else(L// 	{// 		specs[eCreativeInventoryTab_Brewing] = new TabSpec(L"icon_brewing.png", IDS_GROUPNAME_POTIONS, 1, brewingGroup, 4, potionsGroup);// 	}
#ifndef _CONTENT_PACKAGE
	

	ECreative_Inventory_Groups miscGroup[] = {eCreativeInventory_Misc };
	ECreative_Inventory_Groups debugMiscGroup[] = {eCreativeInven"Misc"rtToolsMisc};
	specs[eCreativeInventoryTab_Misc] = new TabSpec(L, ID#elseUPNAME_MISCELLANEOUS, 1, miscGroup, 0, NULL, 1, debugMiscGroup);

	ECreative_Inventory_Groups miscGroup[] = {eCreat"Misc"entory_Misc};
	specs[eCreativeInventoryTab_Mis#endifew TabSpec(L, IDS_GROUPNAME_MISCELLANEOUS, 1, miscGroup);
...
IUIScene_CreativeMenu::IUIScene_CreativeMenu()
{
	...
	m_creativ// 4J JEV - Settup TabsY = m_inventorySlotX = m_inventorySlotY = 0;

	
	for (int i = 0; i < eCreativeInventoryTa/* 4J JEV - Switches between tabs.
*/] = 0;
		m_tabPage[i] = 0;
	}
}

// Could just be changing page on the current tabnventoryTabs tab)
{
...
void IUIScene_CreativeMenu::ScrollBar(UIVec2D pointerPos)
{
	UIVec2D pos;
	UIVec2D size;
	GetItemScreenData(eSectionInventoryCreativeSlider, 0, &pos, // clamp	float fPosition = ((float)pointerPos.y - pos.y) /  size.y;

	
	if(fPosition >// calculate page position according to page countfPosition = 0.0f;

	
	int iCurrentPag// set tab page(fPosition * (specs[m_curTab]->getPageCo// update tab
	
	m_tabPa// 4J JEV - Tab Spec Struct;
...
IUIScene_CreativeMenu::TabSpec::TabSpec(LPCWSTR icon, int descriptionId, int staticGroupsCount, ECreative_Inventory_Groups *staticGroups, int dynamicGroupsC/*= 0*/Creative_Inventory_Groups *dynamicGroups, /*= NULL*/roupsCount , ECreative_Inventory_Groups *debugGroups )
...
void IUIScene_CreativeMenu::TabSpec::populateMenu(AbstractContainerMenu *m// Fill the dynamic groupsigned int page)
{
	int lastSlotIndex = 0;
	...
	if(m_dynamicGroupsCount > 0 && m_dynamicGroupsA != NULL)
	{
		...
		{
			Slot // Fill from the static groupsotIndex);
			slot->set( *it );
		}
	}
	...
	if(displayStatic)
	{
		for(; lastSlotIndex < MAX_SIZE;)
		{
			...
			if(currentItem >= categoryGroups[m_staticGroupsA[currentGroup]].size())
			{
				...
				++currentGroup;
				if(cur
#ifndef _CONTENT_PACKAGEpsCount)
				{
					break;
				}
			}
		...
		if(m_debugGroupsCount > 0)
		{
			...
			for(; lastSlotIndex < MAX_SIZE;)
			{
				...
				if(currentItem >= categoryGroups[m_debugGroupsA[currentGroup]].size())
				{
					currentItem = 0;
					++currentGroup;
					if(currentGrou#endif_debugGroupsCount)
					{
						break;
					}
				}
	...
	{
		Slot *slot = menu->getSlot(lastSlotIndex);
		slot->remove(1)#ifndef _CONTENT_PACKAGEScene_CreativeMenu::TabSpec::getPageCount()
{

	if(app.DebugArtToolsOn())
	{
		return (int)ce#endifoat)(m_staticItems + m_debugI// 4J JEV - Item Picker Menu
	else
...
IUIScene_CreativeMenu::ItemPickerMenu::ItemPickerMenu(	std::shared_ptr<SimpleContainer> smp, std::shared_ptr<Inventory> inv ) : Abs//int startLength = slots->size();= inv;
	creativeContainer = smp; 

	

// 4J JEV -  These values get set by addSlot anyway.X_SIZE; i++)
	{
	...
	for (int i = 0; i < 9; i++)
	{
		slot = new // 4J Stu - Give the creative menu a unique container id slot );
	}
...
IUIScene_AbstractContainerMenu::ESceneSection IUIScene_CreativeMenu::GetSectionAndSlotInDirection( ESceneSection eSection, ETapState eTapDirection, int *// Find the new section if there is onection newSection = eSection;
	...
	case eSe/* do nothing */eativeTab_7:
...
bool IUIScene_CreativeMen// 4J Added - Make pressing the X button clear the hotbarkKeyHeld)
{
...
// call this function to synchronize multiplayer item barullptr);
...
void IUIScene_CreativeMenu// Drop items.eClicked(int iPad, int buttonNum, BOOL quickKeyHeld)
{
	...
	if (playerInventory->getCarried() != NULL)
	{
		...
		if (buttonNum == 1)
		{
			...
			if (playerInventory->get//pMinecraft->localgameModes[m_iPad]->handleInventoryMouseClick(menu->containerId, AbstractContainerMenu::CLICKED_OUTSIDE, buttonNum, quickKeyHeld?true:false, pMinecraft->localplayers[m_iPad] );
}

void IUIScene_CreativeMenu::handleAdditionalKeyPress(int iAction)
{
	int dir // Fall through intentionalase ACTION_MENU_LEFT_SCROLL:
		dir = -1;
...
void IUIScene_CreativeMenu::handleSlotListClicked(ESceneSection eSection, int buttonNum, BOOL quickKeyHeld)
{
	...
	if(instantPlace || eSection == eSectionInventoryCreativeUsing)
	{
		...
		std::shared_pt// call this function to synchronize multiplayer item bargetItem();
...
bool IUIScene_CreativeMenu::getEmptyInventorySlot(std::shared_ptr<ItemInstance> item, int // Jump to the slot with this item already on it, if we can stack more
	for(unsigned int i = TabSpec::MAX_SIZE; i < TabSpec::MAX_SIZE + 9; ++i)
	{
...
void IUIScene_CreativeMenu::BuildFirework(std::vector<std::shared_ptr<ItemInstance> > *std::list,/*= -1*/pe, i/////////////////////////////////er// Create firechargede/////////////////////////////////
	...
	std::// glowstone dust gives flickeringback(DyePowderItem::COLOR_RGB[color]);

	// diamonds give trails->putBoolean(FireworksItem::TAG_E_FLICKER, true);
	...
	{
		colorArray[i] = colors// delete colorArray.data;Array(FireworksItem::TAG_E_COLORS, colorArray);
	

	exp////////////////////////////////////PE,// Apply fade colors to firecharge		////////////////////////////////////		
