...
typedef struct internal_state {
    ...
    uInt ins_h;     /* hash index of std::string to be inserted */
    ...
    uInt strstart;       /* start of std::string to insert */
    uInt match_start;    /* start of matching std::string */
...
#define max_insert_length max_lazy_match
    ...
    uInt matches;   /* number of std::string matches in current block */
