...
void CGameNetworkManager::GameInviteReceived(int userIndex,
    ...
    if (joiningUsers > 1 && !RenderManager.IsHiDef() &&
        ...
        if (!g_NetworkManager.IsInSession()) {
            ...
            // dwLocalUsersMask; 			joinData->pInviteInfo = pInviteInfo;
...
void CGameNetworkManager::ServerReady() { m_hServerReadyEvent->Set(); }
...
void CGameNetworkManager::ServerStopped() { m_hServerStoppedEvent->Set(); }
