...
public:
    ...
    void loadBaseSaveData();
        static int packMounted(LPVOID pParam,i// 4J-JEV:OR// ApplySchematicRules contain limited state	// which needs to be reset BEFORE a new game starts.// 4J-JEV:// This file contains state that needs to be deleted// or reset once a game has finished.
