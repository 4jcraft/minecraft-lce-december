...
typedef struct {
    ...
    union {
        struct {
            ...
            // was 192
            // unsigned char
            // ucUnused[192-TUTORIAL_PROFILE_STORAGE_BYTES-sizeof(DWORD)-sizeof(char)-sizeof(char)-sizeof(char)-sizeof(char)-sizeof(LONG)-sizeof(LONG)-sizeof(DWORD)];
...
#else
    int (*CallbackFunc)(LPVOID, int, int, C4JStorage::PTMSPP_FILEDATA,
                        LPCSTR szFilename);
#endif
