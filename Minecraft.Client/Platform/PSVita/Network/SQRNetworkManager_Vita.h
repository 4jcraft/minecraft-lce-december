...
public:
    ...
    static void GetJoinablePresenceDataAndProcess(
    ...
    static int PSNSignInReturnedPresenceInvite(void* pParam, bool bContinue,
                                               int iPad);
...
private:
    ...
    bool CreateRudpConnections(SceNpMatching2RoomId roomId,
                               SceNpMatching2RoomMemberId peerMemberId,
                               int playerMask,
                               SceNpMatching2RoomMemberId playersPeerMemberId);
    ...
    static void ContextCallback(SceNpMatching2ContextId id,
                                SceNpMatching2Event event,
                                SceNpMatching2EventCause eventCause,
                                int errorCode, void* arg);
    // #ifdef __PS3__
    // 	static void
    ...
    static void DefaultRequestCallback(SceNpMatching2ContextId id,
                                       SceNpMatching2RequestId reqId,
                                       SceNpMatching2Event event, int errorCode,
                                       const void* data, void* arg);
    static void RoomEventCallback(SceNpMatching2ContextId id,
                                  SceNpMatching2RoomId roomId,
                                  SceNpMatching2Event event, const void* data,
                                  void* arg);
    // #endif
    static void SignallingCallback(SceNpMatching2ContextId ctxId,
                                   SceNpMatching2RoomId roomId,
                                   SceNpMatching2RoomMemberId peerMemberId,
                                   SceNpMatching2Event event, int error_code,
                                   void* arg);
...
private:
    static void UpdateRichPresenceCustomData(void* data,
    ...
    // 4J-PB - so we can stop the crash when Iggy's LoadMovie is called from the
    // ContextCallback
