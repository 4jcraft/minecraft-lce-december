...
HANDLE CreateThread(void* lpThreadAttributes, DWORD dwStackSize,
...
#define VIRTUAL_OFFSET \
    1000000  // we use this just so we don't indicate 'out of memory' to
             // ConsoleSaveFile by returning 0
