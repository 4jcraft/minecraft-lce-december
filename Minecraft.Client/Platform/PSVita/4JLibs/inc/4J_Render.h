...
public:
    ...
    typedef enum {
        VERTEX_TYPE_PF3_TF2_CB4_NB4_XW1,  // Position 3 x float, texture 2 x
                                          // float, colour 4 x uint8_t, normal 4 x
                                          // uint8_t, padding 1 DWORD
...
#ifdef __PSVITA__
    void DrawVerticesCutOut(ePrimitiveType PrimitiveType, int count,
    ...
    void StateSetTexGenCol(int col, float x, float y, float z, float w,
                           bool eyeSpace);
    void StateSetStencil(SceGxmStencilFunc Function, uint8_t stencil_func_mask,
    ...
    void* allocGPURWMem(const std::size_t size,
                        const std::size_t alignment = 16);
    void freeGPURWMem(void* mem);
    void* allocGPUROMem(const std::size_t size,
                        const std::size_t alignment = 16);
    void freeGPUROMem(void* mem);
    void* allocGPUCDMem(const std::size_t size,
                        const std::size_t alignment = 16);
