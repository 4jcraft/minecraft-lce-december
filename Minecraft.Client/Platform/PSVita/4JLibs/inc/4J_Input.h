...
public:
    ...
    void SetDebugSequence(const char* chSequenceA, int (*Func)(LPVOID),
                          LPVOID lpParam);
    ...
    //
    // 		Remarks
    // 		This requirement applies to any player-entered std::string that
    // can be exposed to other players on Xbox LIVE. It includes session names,
