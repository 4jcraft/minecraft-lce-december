...
// You still need to include regular iggyperfmon.h first. This is just for
// convenience.

#define IggyPerfmonDPadWithShift(ctrldata, testfor) \
    ((testfor) == ((ctrldata).buttons & ((testfor) | SCE_CTRL_L | SCE_CTRL_R)))
...
#define IggyPerfmonPadFromSceCtrlData(pad, ctrldata)                           \
    ...
    (pad).field.dpad_right =                                                   \
        IggyPerfmonDPadWithShift(ctrldata, SCE_CTRL_RIGHT),                    \
    ...
    (pad).field.shoulder_left_hi =                                             \
        IggyPerfmonDPadWithShift(ctrldata, SCE_CTRL_LEFT | SCE_CTRL_L),        \
    (pad).field.shoulder_right_hi =                                            \
        IggyPerfmonDPadWithShift(ctrldata, SCE_CTRL_RIGHT | SCE_CTRL_L),       \
    (pad).field.trigger_left_low =                                             \
        IggyPerfmonDPadWithShift(ctrldata, SCE_CTRL_LEFT | SCE_CTRL_R),        \
    (pad).field.trigger_right_low =                                            \
        IggyPerfmonDPadWithShift(ctrldata, SCE_CTRL_RIGHT | SCE_CTRL_R)
