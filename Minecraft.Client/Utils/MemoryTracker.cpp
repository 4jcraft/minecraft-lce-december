...
void MemoryTracker::release(//for (Map.Entry<Integer, Integer> entry : GL_LIST_IDS.entrySet())
...
ByteBuffer *MemoryTracker::createByteBuffer(int size// 4J - was ByteBuffer.allocateDirect(size).order(ByteOrder.nativeOrder())
