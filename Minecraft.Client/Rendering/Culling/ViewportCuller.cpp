...
bool ViewportCuller::Face::inFront(double x0, double y0, double z0, double x1,
                                   double y1, double z1) {
...
bool ViewportCuller::Face::fullyInFront(double x0, double y0, double z0,
...
ViewportCuller::ViewportCuller(std::shared_ptr<LivingEntity> mob,
    ...
    faces[5] = Face(x + xd * fogDistance, y + yd * fogDistance,
                    z + zd * fogDistance, yRot + 180, -xRot);
}
...
bool ViewportCuller::cubeInFrustum(double x0, double y0, double z0, double x1,
                                   double y1, double z1) {
    x0 -= xOff;
    y0 -= yOff;
    z0 -= zOff;
...
bool ViewportCuller::cubeFullyInFrustum(double x0, double y0, double z0,
                                        double x1, double y1, double z1) {
    x0 -= xOff;
    y0 -= yOff;
    z0 -= zOff;
