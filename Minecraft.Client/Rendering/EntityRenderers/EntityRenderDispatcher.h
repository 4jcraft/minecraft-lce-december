...
public:
    ...
    void prepare(Level *level, Textures *textures, Font *font, std::shared_ptr<LivingEntity> player, std::shared_ptr<LivingEntity> crosshairPickMob, Options *options, float a);
...
private:
	void renderHitbox(std::shared_ptr<Entity> entity, double x, double y, double z, float rot, float a);
