...
void OcelotRenderer::scale(std::shared_ptr<LivingEntity> _mob, float a// 4J - original version used generics and thus had an input parameter of type Blaze rather than shared_ptr<Entity>  we have here - // do some casting around instead
