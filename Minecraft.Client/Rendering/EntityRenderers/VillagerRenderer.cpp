...
int VillagerRenderer::prepareArmor(std::shared_ptr<LivingEntity> villager, int layer, float a)
{
	return -1;
}
...
ResourceLocation *VillagerRenderer::getTextureLocation(std::shared_ptr<Entity> _mob)
{
...
void VillagerRenderer::additionalRendering(std::shared_ptr<LivingEntity> mob, float a)
{
