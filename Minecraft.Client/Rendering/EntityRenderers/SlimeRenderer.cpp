...
void SlimeRenderer::scale(std::shared_ptr<LivingEntity> _slime, float a// 4J - dynamic cast required because we aren't using templates/generics in our version
	std::shared_ptr<Slime> slime = dynamic_pointer_cast<Slime>(_slime);
