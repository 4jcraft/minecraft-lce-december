...
void FireballRenderer::render(std::shared_ptr<Entity> _fireball, double x,
    ...
    glScalef(s / 1.0f, s / 1.0f, s / 1.0f);
        Icon *icon = Item::fireball->getIcon(fireball->GetType()==eTYPE_DRAGON_FIREBALL?//14 + 2 * 16;
	MemSect(31);
    ...
    glPopMatrix();// 4J Added override. Based on EntityRenderer::renderFlame
void FireballRenderer::renderFlame(std::shared_ptr<Entity> e, double x, double y, double z, float a)
{
        ...
        t->vertexUV((float)(r - xo), (float)(0 - yo), (float)(0), (float)(u0),
                    (float)(v1));
        t->vertexUV((float)(r - xo), (float)(1.4f - yo), (float)(0),
                    (float)(u0), (float)(v0));
        t->vertexUV((float)(0 - xo), (float)(1.4f - yo), (float)(0),
                    (float)(u1), (float)(v0));
